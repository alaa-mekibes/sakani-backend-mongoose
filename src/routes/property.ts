...
router.patch("/:propertyId", authMiddleware, upload.array('images', 5), validate(updatePropertySchema), validate(propertyIdSchema, 'params'), (req, res) => propertyController.updateProperty(req, res));
